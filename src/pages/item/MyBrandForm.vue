<template>
  <div>
    <v-form v-model="valid" ref="myBrandForm">
      <v-text-field v-model="brand.name" label="请输入品牌名称" required :rules="brand.nameRules"/>
      <v-text-field v-model="brand.letter" label="请输入品牌首字母" required :rules="brand.letterRules"/>
      <v-cascader
  ...
  export default {
    ...
    methods:{
      ...
      clear(){
        ...
        //由于brand下面category有bug不能清空,需要手动清空
